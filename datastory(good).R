...
jy_theme <- function() {
  theme(
    legend.position = "right", legend.title = element_text(colour = "#ec8130", size = 10),
    ...
    plot.title = element_text(colour = "#ec8130", face = "bold", size = 18, 
                              hjust = 0, margin = margin(0, 0, 5, 0, "pt")),
    axis.title = element_text(colour = "#ec8130", face = "bold", size = 13),
